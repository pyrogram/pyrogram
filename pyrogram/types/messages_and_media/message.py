...
class Message(Object, Update):
    ...
    Parameters:
        ...
        invoice (:obj:`~pyrogram.types.MediaInvoice`, *optional*):
            Message is an invoice, information about the invoice.
    ...
    # TODO: Add game missing field, successful_payment, connected_website
    ...
    def __init__(
        ...
        *,
        ...
        invoice: "types.MediaInvoice" = None,
        ...
        if isinstance(message, raw.types.Message):
            ...
            if media:
                if isinstance(media, raw.types.MessageMediaPhoto):
                    ...
                    invoice = types.MediaInvoice._parse(client, media)
                else:
                    media = None
