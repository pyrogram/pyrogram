...
from pyrogram.handlers import (
    ...
    ChosenInlineResultHandler, ChatMemberUpdatedHandler, ChatMemberJoinRequestHandler
)
...
class Dispatcher:
    ...
    def __init__(self, client: "pyrogram.Client"):
        ...
        async def chat_member_join_request_parser(update, users, chats):
            return pyrogram.types.ChatMemberJoinRequest._parse(self.client, update, users, chats), ChatMemberJoinRequestHandler
        ...
        self.update_parsers = {
            ...
            (UpdateBotChatInviteRequester,): chat_member_join_request_parser
        }
